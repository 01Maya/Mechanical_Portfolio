    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a href="#home" className="text-xl font-bold text-foreground tracking-tighter group flex items-center gap-2">
          ...
          <span className="group-hover:text-primary transition-colors hidden sm:inline-block">MEET PATEL</span>
          <span className="group-hover:text-primary transition-colors sm:hidden">MEET</span>
        </a>
